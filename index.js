...
function checkAnswer() {
    ...
    if (selectedAnswer.value === correctAnswer.correct.toString()) {
        document.getElementById('question-person-img').src = './images/yes.webp';
    } else {
        questionText.textContent = 'Wrong Answer. Correct answer is ${correctAnswer.correct.toString()}';
        // Change the image source to a "wrong" image
        document.getElementById('question-person-img').src = './images/wrong.webp';
    }
